...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[prc_rpt_GetPartnerPortalBrowserUsage]
AS
BEGIN
	...
	Select	@TotalCount =	Count(*)
							...
							Where	p.SupplierID <> 265 and BrowserName is not Null and BrowserName <> ''
									and pah.UserID is Not Null and pah.ActivityDate >= GETDATE() - 180
...
END
GO
GRANT EXECUTE ON  [dbo].[prc_rpt_GetPartnerPortalBrowserUsage] TO [PolicyEXDBReader]
GO
