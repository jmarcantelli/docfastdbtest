...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[prc_rpt_PolicyCountCreatedByMonth_All_DistributorsBySupplier]
(
	@SupplierID		Int
)	WITH RECOMPILE
AS
BEGIN
	...
	Insert      into @PolicySuppliers Select  @SupplierID
...
END
GO
GRANT EXECUTE ON  [dbo].[prc_rpt_PolicyCountCreatedByMonth_All_DistributorsBySupplier] TO [PolicyEXDBReader]
GO
