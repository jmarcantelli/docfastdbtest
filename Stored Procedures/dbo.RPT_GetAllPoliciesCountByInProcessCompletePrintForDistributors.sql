...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[RPT_GetAllPoliciesCountByInProcessCompletePrintForDistributors]
(
	@SupplierID		Int,
	@StartDate	DateTime,
	@EndDate DateTime
...
Where	sdi.SupplierID = @SupplierID
		and d.DistributorTypeID =1
		group by d.Name,pc1.[Policy Count] ,pc2.[Policy Count],pc3.[Policy Count]

Order By d.Name
END
GO
GRANT EXECUTE ON  [dbo].[RPT_GetAllPoliciesCountByInProcessCompletePrintForDistributors] TO [PolicyEXDBReader]
GO
